  ...
  static List<BranchModel> getAllBranches({
    ...
    return [
      ...
      BranchModel(
        ...
        isUnlocked: currentSlotCount >= 4 || unlockedBuildings.contains('property_tier_2'),
      ),
      BranchModel(
        id: 'branch_3',
        ...
        isUnlocked: currentSlotCount >= 6 || unlockedBuildings.contains('property_tier_3'),
      ),
      BranchModel(
        id: 'branch_4',
        ...
        dailyBurnRate: 4200.0,
        maxGarageSlots: 8,
        targetLevel: 4,
        profitMultiplier: 1.40,
        vectorIcon: 'tuning',
        unlockedSummary: 'Tuning & Modifiye Stüdyosu, Showroom Mimari Dekorasyon',
        isUnlocked: currentSlotCount >= 8 || unlockedBuildings.contains('property_tier_4'),
      ),
      BranchModel(
        id: 'branch_5',
      ...
      BranchModel(
        ...
        dailyBurnRate: 20000.0,
        maxGarageSlots: 13,
        targetLevel: 6,
        profitMultiplier: 1.85,
        vectorIcon: 'shield',
        unlockedSummary: 'Borsa & Portföy Yatırımları, Banka Mevduat Fonları',
        isUnlocked: currentSlotCount >= 13 || unlockedBuildings.contains('property_tier_6'),
      ),
      BranchModel(
        id: 'branch_7',
      ...
      BranchModel(
        ...
        isUnlocked: currentSlotCount >= 20 || unlockedBuildings.contains('property_tier_8'),
      ),
    ];
  }
}
