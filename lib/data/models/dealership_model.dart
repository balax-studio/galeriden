    ...
    return DealershipModel(
      ...
      sideBusinesses: [
        SideBusinessModel(
          ...
          upgrades: [
            SideBusinessUpgradeModel(id: 'sb_1_u1', title: 'İtalyan Espresso Öğütücü', description: 'Gelen müşterilerin bekleme süresinde taze kahve tüketimini artıran barista modülü.', cost: 3500.0, bonusDailyIncome: 220.0, iconName: 'coffee'),
            SideBusinessUpgradeModel(id: 'sb_1_u2', title: 'Soğuk İçecek & Enerji Kutusu Modülü', description: 'Yaz aylarında otomat satışlarını ikiye katlayan soğutucu hazne.', cost: 6000.0, bonusDailyIncome: 480.0, iconName: 'local_drink'),
            SideBusinessUpgradeModel(id: 'sb_1_u3', title: 'Temassız POS Ödeme Terminali', description: 'Nakit taşımayan müşterilerin doğrudan NFC & Kredi Kartı ile ödeme yapmasını sağlar.', cost: 10000.0, bonusDailyIncome: 850.0, iconName: 'credit_card'),
            SideBusinessUpgradeModel(id: 'sb_1_u4', title: 'Akıllı Atıştırmalık & Sandviç Dolabı', description: 'Gece ve gündüz 24 saat kesintisiz taze gıda imkanı.', cost: 16000.0, bonusDailyIncome: 1400.0, iconName: 'restaurant'),
          ],
        ),
        SideBusinessModel(
          id: 'sb_2',
          ...
          upgrades: [
            SideBusinessUpgradeModel(id: 'sb_2_u1', title: 'Köpük Tabancası & Seramik Şampuan', description: 'Hızlı yıkama kapasitesini artırır ve araç başına kâr marjını yükseltir.', cost: 15000.0, bonusDailyIncome: 1300.0, iconName: 'water_drop'),
            SideBusinessUpgradeModel(id: 'sb_2_u2', title: 'Otomatik Fırçasız Yıkama Tüneli', description: 'Dakikada 2 araç yıkayan tam otomatik yüksek basınçlı konveyör tünel.', cost: 38000.0, bonusDailyIncome: 3000.0, iconName: 'precision_manufacturing'),
            SideBusinessUpgradeModel(id: 'sb_2_u3', title: 'VIP Buharlı Sterilizasyon & Detay', description: 'Araç içi bakterileri yok eden, deri ve döşeme yenileyen VIP alan.', cost: 65000.0, bonusDailyIncome: 5800.0, iconName: 'clean_hands'),
            SideBusinessUpgradeModel(id: 'sb_2_u4', title: 'Seramik Kaplama & Pasta Cila Pad’i', description: 'Sıfır ve ikinci el araçlara profesyonel boya koruma uygulaması.', cost: 110000.0, bonusDailyIncome: 10500.0, iconName: 'auto_awesome'),
          ],
        ),
        SideBusinessModel(
          id: 'sb_3',
          ...
          managerCost: 35000.0,
          managerSalary: 450.0,
          managerBonusPercent: 0.35,
          upgrades: [
            SideBusinessUpgradeModel(id: 'sb_3_u1', title: '4K Ultra HD LED Panel Upgrade', description: 'Yüksek çözünürlüklü ekranlarla premium markalardan reklam al.', cost: 48000.0, bonusDailyIncome: 3800.0, iconName: 'tv'),
            SideBusinessUpgradeModel(id: 'sb_3_u2', title: 'Lazer Gece Gösterisi & 3D Projektör', description: 'Gece trafiğinde sürücülerin dikkatini çeken ikonik lazer gösterisi.', cost: 85000.0, bonusDailyIncome: 7200.0, iconName: 'wb_incandescent'),
            SideBusinessUpgradeModel(id: 'sb_3_u3', title: 'Kurumsal Sigorta & Akaryakıt Sponsorluğu', description: 'Ulusal oto sigorta ve petrol devleriyle sabit yıllık reklam sözleşmesi.', cost: 150000.0, bonusDailyIncome: 13500.0, iconName: 'handshake'),
            SideBusinessUpgradeModel(id: 'sb_3_u4', title: 'AI Odaklı Canlı Trafik Reklam Sistemi', description: 'Kamera verileriyle yoldan geçen araç segmentine göre anlık reklam değiştirir.', cost: 240000.0, bonusDailyIncome: 23000.0, iconName: 'psychology'),
          ],
        ),
        SideBusinessModel(
          id: 'sb_4',
          ...
          managerBonusPercent: 0.30,
          upgrades: [
            SideBusinessUpgradeModel(id: 'sb_4_u1', title: 'Hidrolik Kayar Kasa Vinç', description: 'Lüks ve alçak tabanlı spor araçları sıfır hasarla çekme yeteneği.', cost: 90000.0, bonusDailyIncome: 7500.0, iconName: 'minor_crash'),
            SideBusinessUpgradeModel(id: 'sb_4_u2', title: 'Gece Acil Yol Yardım Sözleşmesi', description: 'Sigorta acenteleriyle anlaşarak gece çağrılarına özel yüksek tarife uygula.', cost: 160000.0, bonusDailyIncome: 14000.0, iconName: 'emergency'),
            SideBusinessUpgradeModel(id: 'sb_4_u3', title: 'Çift Araç Taşıyıcı Ağır Treyler', description: 'Aynı anda 2 aracı birden taşıyabilen ağır hizmet çekici kamyonu.', cost: 260000.0, bonusDailyIncome: 25000.0, iconName: 'fire_truck'),
            SideBusinessUpgradeModel(id: 'sb_4_u4', title: 'Otoyol Devriye Lojistik Merkezi', description: 'Otoyol gişelerine yakın lojistik istasyonuyla çağrı süresini 10 dakikaya indirir.', cost: 420000.0, bonusDailyIncome: 41000.0, iconName: 'alt_route'),
          ],
        ),
        SideBusinessModel(
          id: 'sb_5',
          ...
          managerBonusPercent: 0.30,
          upgrades: [
            SideBusinessUpgradeModel(id: 'sb_5_u1', title: 'Oto Kokusu & Seramik Bakım Stantı', description: 'Hızlı tüketim araç bakım kimyasalları ve lüks oto kokuları stantı.', cost: 22000.0, bonusDailyIncome: 1600.0, iconName: 'sanitizer'),
            SideBusinessUpgradeModel(id: 'sb_5_u2', title: 'Performans Egzoz & Tuning Reyonu', description: 'Spor araç tutkunları için açık hava filtreleri, chip tuning ve egzoz sistemleri.', cost: 55000.0, bonusDailyIncome: 4500.0, iconName: 'speed'),
            SideBusinessUpgradeModel(id: 'sb_5_u3', title: 'Lüks Jant & Lastik Teşhir Vitrini', description: 'Çelik ve döküm alaşım 18-22 inç performans jant takımları vitrini.', cost: 110000.0, bonusDailyIncome: 9500.0, iconName: 'tire_repair'),
            SideBusinessUpgradeModel(id: 'sb_5_u4', title: 'Online E-Ticaret & Kargo Entegrasyonu', description: 'Tüm Türkiye’ye İnternet üzerinden aksesuar ve tuning parçaları kargolama.', cost: 190000.0, bonusDailyIncome: 18500.0, iconName: 'local_shipping'),
          ],
        ),
        SideBusinessModel(
          id: 'sb_6',
          ...
          managerBonusPercent: 0.35,
          upgrades: [
            SideBusinessUpgradeModel(id: 'sb_6_u1', title: 'Dinamometre (Dyno) Güç Test Cihazı', description: 'Motor BG ve tork performansını milisaniyelik ölçen silindir dyno testi.', cost: 45000.0, bonusDailyIncome: 3800.0, iconName: 'speed'),
            SideBusinessUpgradeModel(id: 'sb_6_u2', title: 'Dijital Süspansiyon & Fren Test Hattı', description: 'Amortisör verimliliği ve fren sapmalarını bilgisayarlı rampada test etme.', cost: 80000.0, bonusDailyIncome: 7000.0, iconName: 'build_circle'),
            SideBusinessUpgradeModel(id: 'sb_6_u3', title: 'OBD2 Ağır Vasıta Beyin Tarayıcı', description: 'Gizlenen kilometre ve geçmiş arıza kodlarını ortaya çıkaran lisanslı tarayıcı.', cost: 130000.0, bonusDailyIncome: 12000.0, iconName: 'memory'),
            SideBusinessUpgradeModel(id: 'sb_6_u4', title: 'Mikron Kaporta & Şase Lazer Cihazı', description: 'Kazalı veya boyalı parçaları mikron hassasiyetinde tespit eden mikroskopik tarayıcı.', cost: 220000.0, bonusDailyIncome: 21000.0, iconName: 'center_focus_strong'),
          ],
        ),
        SideBusinessModel(
          id: 'sb_7',
          ...
          managerCost: 50000.0,
          managerSalary: 600.0,
          managerBonusPercent: 0.40,
          upgrades: [
            SideBusinessUpgradeModel(id: 'sb_7_u1', title: 'Şehir İçi Günlük Kiralama Filosu', description: 'Havalimanı ve otogarlarda turistlere ve iş insanlarına araç teslimi.', cost: 85000.0, bonusDailyIncome: 7500.0, iconName: 'flight_land'),
            SideBusinessUpgradeModel(id: 'sb_7_u2', title: 'VIP Makam Aracı & Şoförlü Transfer', description: 'Siyah camlı lüks SUV ve sedan araçlarla özel lansman transferleri.', cost: 160000.0, bonusDailyIncome: 15000.0, iconName: 'airline_seat_recline_extra'),
            SideBusinessUpgradeModel(id: 'sb_7_u3', title: 'Kurumsal Şirket Filo Sözleşmeleri', description: 'Holdinglere 12 aylık filo kiralama yaparak düzenli nakit akışı oluşturma.', cost: 300000.0, bonusDailyIncome: 29000.0, iconName: 'business_center'),
            SideBusinessUpgradeModel(id: 'sb_7_u4', title: 'Akıllı Mobil Araç Paylaşım Uygulaması', description: 'Müşterilerin cep telefonundan kapısını açıp dakika bazlı kiralama yapması.', cost: 500000.0, bonusDailyIncome: 52000.0, iconName: 'phone_android'),
          ],
        ),
        SideBusinessModel(
          id: 'sb_8',
          ...
          managerBonusPercent: 0.35,
          upgrades: [
            SideBusinessUpgradeModel(id: 'sb_8_u1', title: 'AC Type-2 22kW Şarj Prizleri', description: 'Park halindeki araçların 2-4 saatte şarj olmasını sağlayan standart peronlar.', cost: 95000.0, bonusDailyIncome: 8500.0, iconName: 'electric_car'),
            SideBusinessUpgradeModel(id: 'sb_8_u2', title: 'DC 180kW Ultra Hızlı Supercharger', description: '20 dakikada %80 şarj sağlayan sıvı soğutmalı yüksek voltajlı şarj üniteleri.', cost: 210000.0, bonusDailyIncome: 20000.0, iconName: 'bolt'),
            SideBusinessUpgradeModel(id: 'sb_8_u3', title: 'Güneş Panelli Depolama Çatısı', description: 'İstasyon çatısına kurulan solar panellerle elektrik maliyetini sıfırlama.', cost: 380000.0, bonusDailyIncome: 37000.0, iconName: 'solar_power'),
            SideBusinessUpgradeModel(id: 'sb_8_u4', title: 'Batarya Sağlık Ölçüm & Değişim Merkezi', description: 'EV araç bataryalarının hücre bazında tamiri ve hızlı batarya takas istasyonu.', cost: 650000.0, bonusDailyIncome: 68000.0, iconName: 'battery_charging_full'),
          ],
        ),
      ],
      marketStocks: [
