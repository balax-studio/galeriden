  ...
  factory DealershipModel.initial() {
    ...
    return DealershipModel(
      ...
      sideBusinesses: [
        SideBusinessModel(
          id: 'sb_1',
          name: 'Otomat Makinesi',
          description: 'Galeri müşterilerine kahve ve atıştırmalık satarak günlük pasif gelir sağla.',
          type: SideBusinessType.vendingMachine,
          dailyIncome: 150.0,
          cost: 5000.0,
          upgrades: [
            SideBusinessUpgradeModel(id: 'sb_1_u1', title: 'İtalyan Espresso Öğütücü', description: 'Gelen müşterilerin bekleme süresinde kaliteli kahve tüketimini artırır.', cost: 3500.0, bonusDailyIncome: 200.0, iconName: 'coffee'),
            SideBusinessUpgradeModel(id: 'sb_1_u2', title: 'Soğuk İçecek & Enerji Kutusu Modülü', description: 'Yaz aylarında otomat satışlarını ikiye katlar.', cost: 6000.0, bonusDailyIncome: 450.0, iconName: 'local_drink'),
            SideBusinessUpgradeModel(id: 'sb_1_u3', title: 'Temassız POS Ödeme Terminali', description: 'Nakit taşımayan müşterilerin doğrudan kartla ödeme yapmasını sağlar.', cost: 10000.0, bonusDailyIncome: 800.0, iconName: 'credit_card'),
          ],
        ),
        SideBusinessModel(
          id: 'sb_2',
          name: 'Oto Yıkama & Detaylandırma',
          description: 'Galerinin yanında profesyonel oto yıkama ve köpüklü temizleme peronu kur.',
          type: SideBusinessType.carWash,
          dailyIncome: 500.0,
          cost: 25000.0,
          upgrades: [
            SideBusinessUpgradeModel(id: 'sb_2_u1', title: 'Köpük Tabancası & Seramik Şampuan', description: 'Hızlı yıkama kapasitesini artırır ve araç başına kârı yükseltir.', cost: 15000.0, bonusDailyIncome: 1200.0, iconName: 'water_drop'),
            SideBusinessUpgradeModel(id: 'sb_2_u2', title: 'Otomatik Fırçasız Yıkama Tüneli', description: 'Dakikada 2 araç yıkayan tam otomatik konveyör sistem.', cost: 35000.0, bonusDailyIncome: 2800.0, iconName: 'precision_manufacturing'),
            SideBusinessUpgradeModel(id: 'sb_2_u3', title: 'VIP Buharlı Sterilizasyon & Detay', description: 'Araç içi bakterileri yok eden ve döşeme yenileyen VIP alan.', cost: 60000.0, bonusDailyIncome: 5500.0, iconName: 'clean_hands'),
          ],
        ),
        SideBusinessModel(
          id: 'sb_3',
          name: 'Dijital Reklam Panosu',
          description: 'Galerinin ana caddeye bakan cephesine reklam panoları kurarak kurumsal gelir sağla.',
          type: SideBusinessType.billboard,
          dailyIncome: 1000.0,
          cost: 75000.0,
          upgrades: [
            SideBusinessUpgradeModel(id: 'sb_3_u1', title: '4K Ultra HD LED Panel Upgrade', description: 'Yüksek çözünürlüklü dijital ekranlarla daha pahalı markalardan reklam al.', cost: 45000.0, bonusDailyIncome: 3500.0, iconName: 'tv'),
            SideBusinessUpgradeModel(id: 'sb_3_u2', title: 'Lazer Gece Gösterisi & Projektör', description: 'Gece trafiğinde sürücülerin dikkatini çeken 3D lazer gösterisi.', cost: 80000.0, bonusDailyIncome: 6800.0, iconName: 'wb_incandescent'),
            SideBusinessUpgradeModel(id: 'sb_3_u3', title: 'Kurumsal Sponsorluk & Marka Anlaşması', description: 'Ulusal oto sigorta ve akaryakıt devleriyle yıllık sabit reklam sözleşmesi.', cost: 140000.0, bonusDailyIncome: 12500.0, iconName: 'handshake'),
          ],
        ),
        SideBusinessModel(
          id: 'sb_4',
          name: 'Oto Çekici Filosu',
          description: 'Otobanda veya şehir içinde yolda kalan araçlara 7/24 çekici ve yol yardım hizmeti ver.',
          type: SideBusinessType.towTruck,
          dailyIncome: 2500.0,
          cost: 150000.0,
          upgrades: [
            SideBusinessUpgradeModel(id: 'sb_4_u1', title: 'Hidrolik Kayar Kasa Vinç', description: 'Lüks ve alçak tabanlı spor araçları hasarsız çekme yeteneği.', cost: 85000.0, bonusDailyIncome: 7200.0, iconName: 'minor_crash'),
            SideBusinessUpgradeModel(id: 'sb_4_u2', title: 'Gece 7/24 Acil Yol Yardım Sözleşmesi', description: 'Sigorta şirketleriyle anlaşarak gece çağrılarına özel yüksek tarife uygula.', cost: 150000.0, bonusDailyIncome: 13500.0, iconName: 'emergency'),
            SideBusinessUpgradeModel(id: 'sb_4_u3', title: 'Çift Araç Taşıyıcı Ağır Treyler', description: 'Aynı anda 2 aracı birden taşıyabilen ağır çekici kamyonu.', cost: 250000.0, bonusDailyIncome: 24000.0, iconName: 'fire_truck'),
          ],
        ),
        SideBusinessModel(
          id: 'sb_5',
          ...
          cost: 60000.0,
          upgrades: [
            SideBusinessUpgradeModel(id: 'sb_5_u1', title: 'Oto Kokusu & Seramik Bakım Stantı', description: 'Hızlı tüketim araç bakım kimyasalları ve lüks oto kokuları satışı.', cost: 20000.0, bonusDailyIncome: 1500.0, iconName: 'sanitizer'),
            SideBusinessUpgradeModel(id: 'sb_5_u2', title: 'Performans Egzoz & Tuning Reyonu', description: 'Spor araç tutkunları için hava filtreleri, chiptuning ve egzoz uçları.', cost: 50000.0, bonusDailyIncome: 4200.0, iconName: 'speed'),
            SideBusinessUpgradeModel(id: 'sb_5_u3', title: 'Lüks Jant & Lastik Teşhir Vitrini', description: 'Çelik ve döküm alaşım 18-21 inç jant takımları teşhir alanı.', cost: 100000.0, bonusDailyIncome: 9000.0, iconName: 'tire_repair'),
            SideBusinessUpgradeModel(id: 'sb_5_u4', title: 'Online E-Ticaret & Kargo Entegrasyonu', description: 'Tüm Türkiye’ye İnternet üzerinden aksesuar ve yedek parça satışı.', cost: 180000.0, bonusDailyIncome: 17500.0, iconName: 'local_shipping'),
          ],
        ),
      ],
      marketStocks: [
