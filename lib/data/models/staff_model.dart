...
class StaffRoleSpecializations {
  static const List<StaffTrainingCourse> allCourses = [
    ...
    StaffTrainingCourse(
      ...
      description: 'Nano boya korumasıyla temizlik değer artışını güçlendirir.',
    ...
    StaffTrainingCourse(
      ...
      description: 'Derinlemesine iç temizlikle alıcı memnuniyetini yükseltir.',
    ...
    StaffTrainingCourse(
      ...
      description: 'Parça sökümünü hızlandırır, takım kaybını önler.',
    ...
    StaffTrainingCourse(
      ...
      description: 'Kaporta desteğini artırıp tamir hata payını azaltır.',
    ...
    StaffTrainingCourse(
      ...
      description: 'Pazarlıkta düşük teklifleri kırıp kârlı satışı artırır.',
    ...
    StaffTrainingCourse(
      ...
      description: 'Nadir ve lüks araçlara koleksiyoner alıcılar çeker.',
    ...
    StaffTrainingCourse(
      ...
      description: 'Ekspertizsiz araçlardaki gizli motor arızalarını yakalar.',
    ...
    StaffTrainingCourse(
      ...
      description: 'Motor rektifiye ve yazılım işlemlerinde verimi artırır.',
    ...
    StaffTrainingCourse(
      ...
      description: 'Boya ve şasi kontrolünü hızlandırıp süreyi kısaltır.',
    ...
    StaffTrainingCourse(
      ...
      description: 'Kelepir araç fırsatlarını ve net kâr marjını tespit eder.',
    ...
    StaffTrainingCourse(
      ...
      description: 'Vitrin ilanlarının tıklanma ve görüntülenme oranını artırır.',
    ...
    StaffTrainingCourse(
      ...
      description: 'Alıcı trafiğini artırarak araç satış süresini kısaltır.',
    ...
    StaffTrainingCourse(
      ...
      description: 'Şirket giderlerini ve vergi kesintilerini yasal olarak düşürür.',
    ...
    StaffTrainingCourse(
      ...
      description: 'Senet karşılıksız riskini önler, tahsilatı hızlandırır.',
