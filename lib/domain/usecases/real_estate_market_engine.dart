...
class RealEstateMarketEngine {
  ...
  static const List<RealEstateTemplate> templates = [
    ...
    RealEstateTemplate(
      ...
      minM2: 95,
      maxM2: 155,
      minBaseValue: 6800000,
      maxBaseValue: 19500000,
    ...
    RealEstateTemplate(
      ...
      minM2: 80,
      maxM2: 240,
      minBaseValue: 14000000,
      maxBaseValue: 45000000,
      typicalCities: ['İstanbul', 'Ankara', 'İzmir', 'Bursa'],
      descriptions: [
    ...
    RealEstateTemplate(
      ...
      minM2: 450,
      maxM2: 1800,
      minBaseValue: 14500000,
      maxBaseValue: 58000000,
    ...
    RealEstateTemplate(
      ...
      minM2: 1200,
      maxM2: 5000,
      minBaseValue: 24000000,
      maxBaseValue: 85000000,
    ...
    RealEstateTemplate(
      ...
      minM2: 85,
      maxM2: 130,
      minBaseValue: 7500000,
      maxBaseValue: 16500000,
      typicalCities: ['İstanbul', 'Ankara', 'İzmir'],
      descriptions: [
    ...
    RealEstateTemplate(
      ...
      minM2: 600,
      maxM2: 1200,
      minBaseValue: 48000000,
      maxBaseValue: 140000000,
