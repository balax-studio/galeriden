                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  Text(
                                    context.tr('staff_training_remaining',
                                        {'days': '${hired.trainingDaysRemaining}'}),
                                    style: const TextStyle(
                                        fontSize: 10.5,
                                        fontWeight: FontWeight.w900),
                                  ),
                                  Text(
                                    '%${(hired.trainingProgress * 100).toInt()}',
                                    style: const TextStyle(
                                        fontSize: 10.5,
                                        fontWeight: FontWeight.w900,
