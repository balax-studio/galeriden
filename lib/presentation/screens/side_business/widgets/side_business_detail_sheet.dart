            ...
            children: [
              ...
              AppGlassContainer(
                ...
                child: Row(
                  ...
                  children: [
                    _buildStatColumn('Günlük Gelir', '₺${CurrencyFormatter.formatShort(business.effectiveDailyIncome)}', p.successColor, p.isDark),
                    ...
                    Container(width: 1, height: 35, color: p.surfaceBorderColor),
                    _buildStatColumn('Dükkan Seviyesi', 'Lvl ${business.level}', p.secondaryColor, p.isDark),
                  ],
                ),
              ),
              ...
              Text('DÜKKAN KAPASİTE YÜKSELTME', style: AppTypography.labelSmall(p.isDark)),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 2),
                          Text('Baz geliri +%50 artırır.', style: AppTypography.labelSmall(p.isDark)),
                        ],
                      ),
                    ),
                    AppTactileButton(
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('DÜKKAN İÇİ MODÜLLER VE GELİŞTİRMELER', style: AppTypography.labelSmall(p.isDark)),
