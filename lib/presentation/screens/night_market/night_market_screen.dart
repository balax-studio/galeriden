            ...
            children: [
              Column(
                ...
                children: const [
                  ...
                  Text(
                    '₺35.000 + 40 İtibar',
                    style: TextStyle(fontSize: 14, fontWeight: FontWeight.w900, color: AppColors.brutalGreen),
                  ),
                ],
              ),
              NeoBrutalButton(
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Row(
          children: [
            Icon(
              result.isWon ? Icons.emoji_events_rounded : Icons.sentiment_dissatisfied_rounded,
              color: result.isWon ? AppColors.brutalYellow : AppColors.errorRed,
              size: 28,
            ),
          ...
          children: [
            ...
            if (result.isWon)
              Container(
                ...
                child: Text(
                  'Kazanılan: +${CurrencyFormatter.format(result.prizeMoney)} & +${result.reputationBonus} İtibar',
                  style: const TextStyle(
                    fontSize: 12,
                    fontWeight: FontWeight.w900,
                    color: AppColors.brutalGreen,
