...
class _ScrapyardScreenState extends ConsumerState<ScrapyardScreen>
                              ...
                              child: Row(
                                children: [
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          isDismantled
                                              ? context
                                                  .tr('scrap_dismantled_status')
                                              : context
                                                  .tr('scrap_condition_value', {
                                                  'cond':
                                                      '${part.conditionPercent}',
                                  ...
                                  NeoBrutalButton(
                                    label: isDismantled
                                        ? context
                                            .tr('scrap_btn_dismantled_badge')
                                        : context
                                            .tr('scrap_btn_dismantle_take'),
                                    icon: isDismantled
  ...
  void _handleDismantleChoice(
      BuildContext context, ScrapyardCar car, SalvagedPart part) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    showDialog(
      context: context,
      builder: (ctx) => Dialog(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        context.tr('scrap_remaining_searches',
                  ...
                  NeoBrutalBadge(
                    text: context.tr('scrap_searches_badge',
                        {'count': '${game.remainingScrapSearchesToday}'}),
                    backgroundColor: AppColors.brutalYellow,
                    textColor: Colors.black,
                    fontSize: 10,
          ...
          Builder(
            builder: (context) {
              ...
              return ListView.builder(
                ...
                itemCount:
                    activeScrapCars.isEmpty ? 2 : activeScrapCars.length + 1,
                        ...
                        child: Column(
                          children: [
                            ...
                            Row(
                              children: [
                                Expanded(
                                  child: Builder(
                                    builder: (context) {
                                      final bool canWorkGig = game
                                                  .lastScrapyardGigDate ==
                                              null ||
                                          DateTime.now()
                                                  .difference(game
                                                      .lastScrapyardGigDate!)
                            ...
                            NeoBrutalButton(
                              ...
                              onPressed: () =>
                                  _showScrapyardZoneSearchSheet(context),
                            ),
                          ],
                        ),
                      ),
                    ...
                    child: NeoBrutalCard(
                      ...
                      child: Column(
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  NeoBrutalBadge(
                                    text:
                                        context.tr('scrap_badge_heavy_damage'),
                          ...
                          Text(
                            context.tr(
                                'scrap_damage_note', {'note': car.damageNote}),
                            style: const TextStyle(
                                fontSize: 11,
                                fontWeight: FontWeight.w600,
                                color: AppColors.brutalOrange),
                              ...
                              Row(
                                children: [
                                  if (!car.isPurchased) ...[
                                    ...
                                    NeoBrutalButton(
                                      label:
                                          context.tr('scrap_btn_dismantle_all'),
                                    ...
                                    NeoBrutalButton(
                                      label:
                                          context.tr('scrap_btn_crush_chassis'),
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    ...
                                    context.tr('scrap_b2b_min_tier', {
                                      'tier': order.minQualityTier.name
                                          .toUpperCase()
                                    }),
                                    style: TextStyle(
                                        fontSize: 10.5,
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                NeoBrutalButton(
                                  ...
                                  onPressed: () =>
                                      _showFulfillOrderDialog(context, order),
                                ),
                              ],
                            ),
                          ],
